...
const SignUp = ({ setListen }) => {
    ...
    const RegisterGmailHandle = () =>{
        ...
        setListen(true);
        var myWindow = window.open(`https://4708-124-158-107-34.ngrok.io/connect/google`, "myWindow", "resizable=yes,top=160,left=700,width=500,height=600");
        myWindow.focus();
    }

    const RegisterFacebookHandle = () =>{
        setListen(true);
        var myWindow = window.open(`https://4708-124-158-107-34.ngrok.io/connect/facebook`, "myWindow", "resizable=yes,top=160,left=700,width=500,height=600");
        myWindow.focus();
    }
